    ...
    <div class="row sponsor">
        <div class="text-center">
            <?php
                ...
                if ( Config::get('services.partners.soprasteria') === 'true' ) { $sponsors[] = [ 'link' => 'https://www.soprasteriarecrute.fr/', 'img' => asset("img/sponsors/soprasteria.png"), 'alt' => 'Sopra Steria' ]; }
