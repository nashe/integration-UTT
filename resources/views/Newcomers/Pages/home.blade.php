...
<div class="box box-default">
        ...
        <div class="box-body">
            ...
            <p>
                ...
                @if(Auth::user()->branch == 'TC' || Auth::user()->branch == 'SN_APPR' || Auth::user()->branch == 'GM_APPR' || Auth::user()->branch == 'GI_APPR')
                ...
                @elseif( in_array( Auth::user()->branch, array('ISC','PAIP-GS', 'RE') ) )
