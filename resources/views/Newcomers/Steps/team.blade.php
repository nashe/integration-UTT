        ...
        <div class="box-header with-border">
            ...
            <div class="box-body">
                ...
                <div class="text-center">
                    <a href="https://dis cord.gg/Ea8XwgX5HS" target="_blank" id="discord-btn" class="btn btn-primary btn-lg">Clique ici pour rejoindre le channel discord de ton équipe</a>
                </div>
                <div class="text-center">
