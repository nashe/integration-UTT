                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{ route('newcomer.app') }}">Réseaux sociaux{!! Auth::user()->isPageChecked('app_download')?' <i class="fa fa-check" aria-hidden="true"></i>':'' !!}</a></li>
                                ...
                                @if(Auth::user()->team_id != null)
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="{{ route("challenges.leaderboard") }}">Classement des factions</a></li>
                                        </ul>
                                    </li>
                                @endif
