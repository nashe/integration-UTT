...
@section('content')
    ...
    <div class="callout callout-info">
        ...
        <p>
            Pour créer un type de permanence, renseignez son nom, par exemple "Perm bouffe", "Perm Sécu",...
            Une description qui servira de description par défaut lors de la création de la perm (#gaindetemps),
            Les points de la perm, qui correspond aux nombres de points que donne une perm. Plus une perm est chiante,
            plus elle donne de points. Plus une personne fait des perms chiante, plus elle accumule de points et plus elle a de chances
        ...
        <div class="box-body table-responsive">
            <form autocomplete="off" action="{{ url('dashboard/permType') }}" method="post" id="form">
                ...
                <div class="form-group" id="student_autocomplete_container">
                    <label>Ajouter des respos par nom/prénom</label>
